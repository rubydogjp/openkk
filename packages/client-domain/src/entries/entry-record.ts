  ...
  return [
    {
      ...
      credit: "売上",
      creditType: "revenue",
      creditAmount: "520,000",
      description: "Web制作業務 - A社",
      partner: "サンプル取引先A",
      businessRate: "",
      taxCategory: "課税 10%",
    ...
    {
      id: "entry-2026-01-communication",
      fiscalPeriodId: "fp-2026",
      date: "2026-01-30",
      weekday: "金",
      debit: "通信費",
    ...
    },
    {
      ...
      credit: "売上",
      creditType: "revenue",
      creditAmount: "480,000",
      description: "保守運用業務 - A社",
      partner: "サンプル取引先A",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "第5種（サービス業等）",
    ...
    },
    {
      ...
      credit: "普通預金",
      creditType: "asset",
      creditAmount: "596,000",
      description: "大型案件素材の仕入",
      partner: "",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "",
    ...
    },
    {
      ...
      credit: "売上",
      creditType: "revenue",
      creditAmount: "460,000",
      description: "商品制作 - B商店",
      partner: "サンプル取引先B",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "第5種（サービス業等）",
    ...
    {
      id: "entry-2026-03-communication",
      fiscalPeriodId: "fp-2026",
      date: "2026-03-18",
      weekday: "水",
      debit: "通信費",
    ...
    },
    {
      ...
      credit: "売上",
      creditType: "revenue",
      creditAmount: "510,000",
      description: "運用支援業務 - C社",
      partner: "DELTA商事",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "第5種（サービス業等）",
    ...
    },
    {
      ...
      credit: "売上",
      creditType: "revenue",
      creditAmount: "470,000",
      description: "ECサイト改修 - A社",
      partner: "サンプル取引先A",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "第5種（サービス業等）",
    },
    {
      ...
      credit: "普通預金",
      creditType: "asset",
      creditAmount: "428,000",
      description: "動画制作素材の仕入",
      partner: "",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "",
    ...
    },
    {
      ...
      credit: "売上",
      creditType: "revenue",
      creditAmount: "560,000",
      description: "月次運用 - B商店",
      partner: "サンプル取引先B",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "第5種（サービス業等）",
    ...
    {
      id: "entry-2026-06-communication",
      fiscalPeriodId: "fp-2026",
      date: "2026-06-06",
      weekday: "土",
      debit: "通信費",
    ...
    },
    {
      ...
      credit: "普通預金",
      creditType: "asset",
      creditAmount: "218,000",
      description: "夏案件素材の仕入",
      partner: "",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "",
    },
    {
      ...
      credit: "売上",
      creditType: "revenue",
      creditAmount: "700,000",
      description: "大型LP制作 - C社",
      partner: "DELTA商事",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "第5種（サービス業等）",
    },
    {
      ...
      credit: "普通預金",
      creditType: "asset",
      creditAmount: "176,000",
      description: "案件用商品の仕入",
      partner: "",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "",
    ...
    },
    {
      ...
      credit: "売上",
      creditType: "revenue",
      creditAmount: "630,000",
      description: "継続改善業務 - A社",
      partner: "サンプル取引先A",
      businessRate: "",
      taxCategory: "課税 10%",
      businessCategory: "第5種（サービス業等）",
    ...
    {
      id: "entry-2026-08-communication",
      fiscalPeriodId: "fp-2026",
      date: "2026-08-29",
      weekday: "土",
      debit: "通信費",
    ...
    {
      id: "entry-2026-09-communication",
      fiscalPeriodId: "fp-2026",
      date: "2026-09-29",
      weekday: "火",
      debit: "通信費",
